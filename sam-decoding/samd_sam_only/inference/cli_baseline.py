...
CUDA_VISIBLE_DEVICES=0 python -m samd_sam_only.inference.cli_baseline --model /data/models/vicuna-7b-v1.3
Other commands:
...
def main(args):
    ...
    try:
        ...
        sam = None
        samd_config = SamdConfig(max_predicts=1)
        draft = DraftModel(
            samd_config,
            sam_dyn=None,
            sam_static=sam,
        ...
        while True:
            ...
            try:
                ...
                outputs = chatio.stream_output(
                    samd_model.stream_generate_baseline(
                        input_ids,
                        tokenizer,
